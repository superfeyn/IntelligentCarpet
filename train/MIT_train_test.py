...
parser.add_argument('--ckpt', type=str, default ='singlePeople_0.0001_10_best', help='loaded ckpt file')
...
base_dir = os.getcwd() + '/'
args.exp_dir = base_dir + args.exp_dir
...
if not args.eval:
    train_path = base_dir + "walking_data/train/"#'exp1_train_dataset_more'
    mask = []
    train_dataset = sample_data(train_path, args.window, mask, args.subsample)
    train_dataloader = DataLoader(train_dataset, batch_size=args.batch_size,shuffle=True, num_workers=8)
    print (len(train_dataset))

    val_path = base_dir + "walking_data/val/"#'exp1_val_dataset_more'
    mask = []
